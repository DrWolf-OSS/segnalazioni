...
public enum Constants {
	ADMIN("admin"), SMISTATORE("smistatore"), CITTADINO("cittadino"), INIZIA(
			"inizia"), UFFICIO_COMPETENTE("ufficioCompetente"), IMPIEGATO(
			"impiegato"), CHIUDI_SEGNALAZIONE("chiudiSegnalazione"), ATTENDI_CHIUSURA(
			"attendiChiusura"), CANALE_WWW_NOME("www"), CANALE_WWW_DESC(
