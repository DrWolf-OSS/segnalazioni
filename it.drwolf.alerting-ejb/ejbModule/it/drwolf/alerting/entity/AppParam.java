...
public class AppParam implements Serializable {
	...
	public static final AppParam APP_MAIL_FROM = new AppParam("app.mail.from", "jboss@drwolf.it");

	public static final AppParam APP_SKIN = new AppParam("app.skin", "ruby");

	public static final AppParam APP_COMUNE = new AppParam("app.comune", "Lastra a Signa");
	...
	public static final AppParam APP_MAIL_HOST = new AppParam("app.mail.host", "mail.drwolf.it");
	...
	public static final AppParam[] defaults = new AppParam[] { AppParam.APP_NAME, AppParam.APP_DESCRIPTION, AppParam.APP_SKIN, AppParam.APP_WELCOME, AppParam.APP_COMUNE,
			AppParam.APP_SSOAPPID, AppParam.APP_URL, AppParam.APP_SEGNALAZIONE_SCADENZA, AppParam.APP_MAIL_HOST, AppParam.APP_SEGNALAZIONE_REMINDER_START, AppParam.APP_MAIL_FROM,
			...
			AppParam.ALFRESCO_URL, AppParam.ALFRESCO_USERNAME, AppParam.ALFRESCO_PASSWORD, AppParam.ALFRESCO_CALEEARTH_PATH };
