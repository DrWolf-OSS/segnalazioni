...
public class AppParam implements Serializable {
	...
	public static final AppParam RIPASSA_URP_POOL = new AppParam(
			"ripassa.urp.pool", "false");
	...
	public static final AppParam ALFRESCO_CALEEARTH_PATH = new AppParam(
			"alfresco.caleearth.path", "/CaleEarth/prova");

	public static final AppParam HISTORY_ENABLED = new AppParam(
			"history.enabled", "true");

	public static final AppParam AUTOCOMPLETE_INDIRIZZO_ACTIVE = new AppParam(
			"autocomplete.indirizzo.active", "false");

	public static final AppParam NASCONDI_DIRIGENTI = new AppParam(
			"nascondi.dirigenti", "false");
	...
	public static final AppParam[] defaults = new AppParam[] {
			...
			AppParam.RIPASSA_URP_POOL, AppParam.ALFRESCO_PASSWORD,
			AppParam.ALFRESCO_CALEEARTH_PATH, AppParam.HISTORY_ENABLED,
